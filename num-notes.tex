...
% \addbibresource{includes/citations.bib} Biblatex. See includes/formatting.tex

% Document Metadata
\title{
  \textbf{\textsc{Goldsmiths, \\ University of London CM1015:}} \\ Notes on Numerical Mathematics
}
\author{
